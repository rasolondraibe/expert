...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/wamp/www/expert/expert/app/cache/prod/annotations', false);
    }

    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/wamp/www/expert/expert/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4b56bf25d1de92b80306fafa3532e4da');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4b56bf25d1de92b80306fafa3532e4da');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4b56bf25d1de92b80306fafa3532e4da');
        ...
        $d->setProxyDir('D:/wamp/www/expert/expert/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/wamp/www/expert/expert/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/wamp/www/expert/expert/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/wamp/www/expert/expert/app/cache/prod/sessions');
    }

    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/wamp/www/expert/expert/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/wamp/www/expert/expert/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/wamp/www/expert/expert/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/wamp/www/expert/expert/app/cache/prod',
            ...
            'session.save_path' => 'D:/wamp/www/expert/expert/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/wamp/www/expert/expert/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/wamp/www/expert/expert/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/wamp/www/expert/expert/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/wamp/www/expert/expert/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/wamp/www/expert/expert/app/cache/prod/doctrine/orm/Proxies',
